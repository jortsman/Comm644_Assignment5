...
// var myBtn = document.getElementById("domBtn");
// myBtn.onclick = function() {
//   alert("I have been clicked...this time by the Dom Element Method");
// }
...
// eListen.addEventListener("click", btnClick);
// function btnClick() {
//   alert("I have been clicked via the addEventListener method!");
// }
...
//   alert("I have been clicked via callback bruuuhh.");
// });
...
// Release the script from comment in the head of the index page
// document.addEventListener("DOMContentLoaded", init, false);
// function init() {
//   eListen.addEventListener("click", function() {
//     alert("I have been clicked when the DOM has loaded.");
//   }, false);
// }
...
// e.preventDefault();
// alert("You wanted to go to Google, but I ain't takin' you anywhere");
// }, false);
...
//   myWindow = window.open("newpage.html","","width=300,height=300,resizable=yes");
//   myWindow.focus();
...
// startInterval.addEventListener("click", timer);
// function timer() {
//   console.log("boo");
// }
